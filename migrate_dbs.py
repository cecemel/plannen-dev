...
DATABASE_IMAGE = "plannen-dev/postgres:latest"
DATABASE_CONTAINER_NAME = "plannen-migration-db"
...
def start_db():
    ...
    time.sleep(10)
    _exec_command("docker run --link {}:postgres plannen-dev/postgres-checker:latest".format(DATABASE_CONTAINER_NAME))
