...
DOCKER_REPO = "plannen-dev"
ELASTIC_IMAGE = "geosolutions/elasticsearch-plugins"
ELASTIC_CONTAINER_NAME = "plannen-elastic-init"
ELASTIC_DATA = "$(pwd)/data/elastic"
STORAGE_PROVIDER_IMAGE = "plannen-dev/storageprovider:latest"
STORAGE_PROVIDER_CONTAINER_NAME = "storageprovider-init"
STORAGE_PROVIDER_DATA = "$(pwd)/data/storageprovider"
STORAGE_PROVIDER_DATA_MAP = "{}:/plannen_store".format(STORAGE_PROVIDER_DATA)
REDIS_IMAGE = "redis"
REDIS_CONTAINER_NAME = "plannen-redis-init"
...
def start_redis():
    ...
    _exec_command("docker run "
                  "--link {}:redis "
                  "plannen-dev/redis-checker:latest"
...
def start_storage_provider():
    ...
    _exec_command("docker run "
                  ...
                  "plannen-dev/storageprovider-checker:latest"
...
def start_elastic():
    ...
    _exec_command("docker run "
                  "--link {}:elastic "
                  "plannen-dev/elastic-checker:latest"
